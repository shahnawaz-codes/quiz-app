...
function seedDatabase() {
    ...
    if ($quizzesCreated === 0 && $questionsAdded === 0) {
        $message = "Database already seeded with 6 sample quizzes and questions!";
    } else {
        $message = "Successfully seeded database! Created {$quizzesCreated} new quizzes and added {$questionsAdded} questions.";
    }
